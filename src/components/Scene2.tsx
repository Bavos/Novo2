...
export const Scene2: React.FC<SceneProps> = ({data}) => {
  ...
  return (
    ...
    >
      <div style={{fontSize: 32, color: '#60a5fa', marginBottom: 20}}>📁 src + data + workflow</div>
    ...
    >
      <div style={{fontSize: 30, color: '#60a5fa', marginBottom: 20}}>📁 src • data • .github/workflows</div>
