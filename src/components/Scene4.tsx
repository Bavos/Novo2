...
export const Scene4: React.FC<SceneProps> = ({data}) => {
  ...
  return (
    ...
    >
      <div style={{fontSize: 32, color: '#60a5fa', marginBottom: 20}}>✅ Commit → ⚙️ Action</div>
    ...
    >
      <div style={{fontSize: 30, color: '#60a5fa', marginBottom: 20}}>✅ git commit → ⚙️ render.yml</div>
