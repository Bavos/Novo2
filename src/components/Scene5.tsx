...
export const Scene5: React.FC<SceneProps> = ({data}) => {
  ...
  return (
    ...
    >
      <div style={{fontSize: 32, color: '#60a5fa', marginBottom: 20}}>📦 Artifact de vídeo</div>
    ...
    >
      <div style={{fontSize: 30, color: '#60a5fa', marginBottom: 20}}>📦 video-final.mp4</div>
